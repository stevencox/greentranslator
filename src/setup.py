...
setup(
      ...
      package_data={ 'greentranslator' : [ 'query/*.sparql', 'swagger_client/*', swagger_client/models/*, swagger_client/apis/* ]},
      version = '0.30',
      ...
      download_url = 'https://github.com/stevencox/greentranslator/archive/0.30.tar.gz',
